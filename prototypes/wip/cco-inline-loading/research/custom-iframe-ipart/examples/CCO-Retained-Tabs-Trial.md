...
Status: experimental, not installed in shared theme. Script: CCO-Retained-Tabs-Trial.js (archived locally: `archive/Custom CCO iPart/examples/CCO-Retained-Tabs-Trial.js`).
