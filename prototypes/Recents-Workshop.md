...
- Maintained markup: `prototypes/Recents-Workshop.source.html`.
- Independent popup and preview styles: `prototypes/Recents-Workshop.css`.
- Independent sample data and interactions: `prototypes/Recents-Workshop.js`.
- Common theme-aligned popup shell: `prototypes/Popup-Shell.css`, shared with the taskbar workshop. Edit it to keep title bars, close controls and footers consistent across both previews.
