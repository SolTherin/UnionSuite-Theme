...
const markup=read('THeme/UnionSuite/guides/usage/templates/List-Templates/Bulletin-Style-Preview.html').replace('{{CURRENT_BULLETIN}}',panel(false)).replace('{{PROPOSED_BULLETIN}}',panel(true));
