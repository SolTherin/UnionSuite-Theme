...
const editor=fs.readFileSync(path.join(root,'THeme/UnionSuite/docs/theme-config.js'),'utf8');
...
const navigation=fs.readFileSync(path.join(root,'THeme/UnionSuite/docs/config-preview.js'),'utf8');
