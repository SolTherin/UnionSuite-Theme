...
// Run from any directory: node tools/build-theme-usage.cjs
...
const embed = read('prototypes/Banner-Shared-Styles.html');
...
const nativeGroupCss = [...uncomment(read('Native CSS/10-UltraWaveResponsive.css')).matchAll(/([^{}]+)\{([^{}]*)\}/g)]
...
const template = read('prototypes/Banner-Template.html');
const compatibilityBehaviour = embed.match(/<script id="us-banner-behaviour">([\s\S]*?)<\/script>/)?.[1];
if (compatibilityBehaviour?.trim() !== behaviour || behaviour !== read('prototypes/Banner-Behaviour.js').trim()) throw Error('Legacy banner copies are out of sync with the theme. Run node .preview/build-banner-preview.cjs first.');
...
const snippets = {
  'agreement-facts': ['prototypes/Banner-Agreement-Facts.html', read('prototypes/Banner-Agreement-Facts.html')],
  'case-details': ['prototypes/Case-Details-Content.html', read('prototypes/Case-Details-Content.html')],
  'copy-button': ['prototypes/Copy-Button-Template.html', read('prototypes/Copy-Button-Template.html')],
  'contact-row': ['prototypes/List-Templates/Contacts-Query-Template.html', read('prototypes/List-Templates/Contacts-Query-Template.html')],
  attention: ['prototypes/Home/Needs-Attention-Content.html', read('prototypes/Home/Needs-Attention-Content.html')],
  'task-row': ['prototypes/List-Templates/Tasks-Completion-Query-Template.html', read('prototypes/List-Templates/Tasks-Completion-Query-Template.html')],
  'task-footer': ['prototypes/List-Templates/Tasks-Query-Footer.html', read('prototypes/List-Templates/Tasks-Query-Footer.html')],
  welcome: ['prototypes/Home/Welcome-Content.html', read('prototypes/Home/Welcome-Content.html')],
  actions: ["prototypes/Action-Menu-Template.html", read("prototypes/Action-Menu-Template.html")],
  "client-actions": ["prototypes/Client-Actions.example.js", read("prototypes/Client-Actions.example.js")],
  master: ['prototypes/Banner-Template.html', template],
  dashboard: ['prototypes/Banner-Dashboard-Template.html', read('prototypes/Banner-Dashboard-Template.html')],
  case: ['prototypes/Banner-Case-Template.html', read('prototypes/Banner-Case-Template.html')],
  contact: ['prototypes/Banner-Contact-Template.html', read('prototypes/Banner-Contact-Template.html')],
  embed: ['prototypes/Banner-Shared-Styles.html', embed],
  'banner-js': ['prototypes/Banner-Behaviour.js', read('prototypes/Banner-Behaviour.js')],
  buttons: ['THeme/UnionSuite/docs/Button-Examples.html', read('THeme/UnionSuite/docs/Button-Examples.html')]
};
...
const allSources = ['tools/switch-examples.cjs','THeme/UnionSuite/docs/document-loader-example.html','THeme/UnionSuite/docs/badge-example.html','tools/cco-sticky-example.cjs','tools/tab-loading-example.cjs','tools/account-menu-example.cjs','THeme/UnionSuite/Scripts/UnionSuiteTaskbar.js','THeme/UnionSuite/docs/taskbar-example.js','tools/taskbar-preview.cjs','tools/dialog-chrome-example.cjs','tools/action-menu-example.cjs','prototypes/Action-Menu-Template.html','prototypes/Client-Actions.example.js','prototypes/Data-Panel-Native-read.html','tools/build-tab-display-options.cjs','prototypes/Tab-Display-Fixture.js','prototypes/CCO-Tabs-Fixture.css','THeme/UnionSuite/docs/busy-examples.cjs','prototypes/Form-Fields.source.html','prototypes/Form-Fields.layout.css','THeme/UnionSuite/zUnionSuite.css', 'THeme/UnionSuite/zUnionSuite.js', 'THeme/UnionSuite/zzClientSpecific.css',
  'THeme/UnionSuite/99-Orion.css', 'Native CSS/10-UltraWaveResponsive.css', 'THEME-BUTTONS.md', 'THeme/UnionSuite/docs/Button-Examples.html',
  'prototypes/Banner-Shared-Styles.html', 'prototypes/Banner-Behaviour.js', 'prototypes/Banner-Template.html',
  'prototypes/Banner-Dashboard-Template.html', 'prototypes/Banner-Contact-Template.html',
  'THeme/UnionSuite/README.md', 'prototypes/Banner-README.md', 'prototypes/Banner-Tabs-Plan.md',
  'THEME-PANEL-ACTIONS.md', 'THEME-ACTIVITY-FEED.md', 'IMIS-CMS-STRUCTURE.md',
  'THeme/UnionSuite/docs/Usage-Guide.source.html', 'THeme/UnionSuite/docs/usage-guide.css',
  'THeme/UnionSuite/docs/usage-guide.js', 'THeme/UnionSuite/docs/guide-search.js', 'THeme/UnionSuite/docs/Brand-Preview.source.html', 'tools/build-theme-usage.cjs', 'tools/theme-sources.cjs',
  'tools/theme-gallery.cjs', 'THeme/UnionSuite/docs/action-catalog.cjs', 'THeme/UnionSuite/docs/example-gallery.css',
  'THeme/UnionSuite/docs/IQA-Example.source.html', 'THeme/UnionSuite/docs/iqa-example.js', 'THeme/UnionSuite/Tabler/tabler-icons.min.css'];
allSources.push('prototypes/Banner-Agreement-Facts.html', 'prototypes/Case-Details-Content.html', 'prototypes/Banner-Case-Template.html', 'prototypes/Copy-Button-Template.html');
...
allSources.push('tools/report-icon-example.cjs');
allSources.push('tools/popup-action-example.cjs');
allSources.push('tools/action-conflict-example.cjs');
allSources.push(...require('./unified-action-example.cjs').sources);
allSources.push(...require('./page-layout-example.cjs').sources);
allSources.push('prototypes/Home/Welcome-Content.html');
...
allSources.push('tools/embedded-cco-example.cjs');
allSources.push('tools/iqa-expand-example.cjs','THeme/UnionSuite/docs/iqa-expand-example.html','THeme/UnionSuite/docs/iqa-expand-example.css','THeme/UnionSuite/docs/iqa-expand-example.js');
allSources.push('.preview/build-bulletin-study.cjs','prototypes/List-Templates/Bulletin-Style-Preview.html','prototypes/List-Templates/Bulletin-Style-Preview.css','prototypes/List-Templates/Bulletin-Style-Preview.js');
allSources.push('THeme/UnionSuite/docs/utility-nav-example.html','THeme/UnionSuite/docs/utility-nav-example.css','THeme/UnionSuite/docs/utility-nav-example.js','THeme/UnionSuite-Client/Branding.css');
...
hash.update(read("tools/section-tabs-example.cjs"));
...
let html = read('THeme/UnionSuite/docs/Usage-Guide.source.html');
function galleryDocument(title,markup) {
  return `<!doctype html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>${esc(title)}</title><style>${tokenCss}\n${nativeGroupCss}\n${nativeButtonCss}\n${buttonCss}\n${actionCss}\n${clientRoots}\n${read('THeme/UnionSuite/docs/example-gallery.css')}</style><script>${themeJs}</script></head><body>${markup}</body></html>`;
}
const busyExamples = require('../THeme/UnionSuite/docs/busy-examples.cjs');
...
const nativePreviewCss = (read('Native CSS/10-UltraWaveResponsive.css') + '\n' + orion)
  .replace(/@import\s+[^;]+;/g, '').replace(/@font-face\s*\{[^}]*\}/g, '');
const brandMarkup = read('THeme/UnionSuite/docs/Brand-Preview.source.html').replace('{{BANNER}}', demoBanner).replace('{{PALETTE}}', palette);
...
const reportMarkup = read('THeme/UnionSuite/docs/IQA-Example.source.html').replace('{{IQA_ROWS}}','<tr class="rgRow"><td>104019</td><td>Alex Morgan</td><td>Sydney Metro</td><td>Active</td><td>Sample record</td></tr>');
const reportDemo = `<!doctype html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>Dummy IQA report</title><style>${nativePreviewCss}\n${theme}\n${clientRoots}</style><script>${themeJs}</script></head><body>${reportMarkup}<script>${read('THeme/UnionSuite/docs/iqa-example.js')}</script></body></html>`;
...
const formMarkup='<form class="us-form" onsubmit="event.preventDefault()"><div class="field-grid">'+read('prototypes/Form-Fields.source.html')+'</div><div class="form-footer"><button type="submit" class="TextButton PrimaryButton">Validate example</button><button type="reset" class="TextButton">Reset</button></div></form>';
const formDemo='<!doctype html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><style>'+nativePreviewCss+'\n'+theme+'\n'+read('prototypes/Form-Fields.layout.css')+'</style></head><body><main>'+formMarkup+'</main><script>'+themeJs+'</script></body></html>';
...
const inserts = {
 ...
 BULLETIN_HEADER_DEMO: iframe('bulletin-header-demo','Staff Bulletin with Manage header button','<!doctype html><html lang="en"><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><style>'+nativePreviewCss+theme+'body{margin:0;padding:16px;background:var(--bg-page)}</style><body>'+require('../.preview/build-bulletin-study.cjs').panel(true,1)+'<p id="bulletin-header-status" role="status">Manage Bulletin opens the management page in a new tab on the live site. Click here for a local demonstration.</p><script>'+require('../.preview/build-bulletin-study.cjs').actionScript+';document.addEventListener("click",function(event){var link=event.target.closest("a");if(!link)return;event.preventDefault();document.getElementById("bulletin-header-status").textContent=link.id==="iqa-manage-bulletin"?"Live destination (new tab): "+link.getAttribute("href"):"Sample bulletin destination."});<\/script></body></html>',true),
 LIST_TEMPLATES: listTemplates.recipes(),
 BADGE_DEMO: iframe("badge-demo","Shared badges in reports and panels", '<!doctype html><html lang="en"><meta charset="utf-8"><meta name="viewport" content="width=device-width, initial-scale=1"><style>'+theme+'body{margin:0;padding:20px;background:var(--bg-surface);color:var(--text-base);font:14px var(--font-ui)}</style><body>'+read('THeme/UnionSuite/docs/badge-example.html')+'</body></html>',true),
 ...
 DOCUMENT_LOADER_DEMO: iframe('document-loader-demo','Document Loader upload and Save','<!doctype html><html lang="en"><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><style>'+nativePreviewCss+theme+'body{margin:0;padding:16px} #document-demo-form .ruFileInput{display:none} .CommandBar,#document-demo-status{max-width:560px;margin:12px auto}</style><body>'+read('THeme/UnionSuite/docs/document-loader-example.html')+'<script>'+themeJs+'<\/script></body></html>',true),
 DATA_PANEL_DEMO: iframe('data-panel-demo','Approved native data panel', '<!doctype html><html lang="en"><meta charset="utf-8"><style>'+nativePreviewCss+theme+iconCss+'body{padding:16px;margin:0}</style><body>'+read('prototypes/Data-Panel-Native-read.html')+'<script>'+themeJs.match(/\/\* US-DATA-PANELS:START[\s\S]*?US-DATA-PANELS:END \*\//)[0]+';document.addEventListener("click",e=>e.preventDefault(),true);<\/script></body></html>',true),
 ...
 MESSAGE_DEMO: iframe('message-demo','Native iMIS feedback messages with Union Suite styling',messageDemo,true),
  ...
  TOKENS_CSS: tokenCss + '\n' + clientRoots,
  GUIDE_CSS: read('THeme/UnionSuite/docs/usage-guide.css'),
  GUIDE_JS: read('THeme/UnionSuite/docs/usage-guide.js'),
  GUIDE_SEARCH_JS: read('THeme/UnionSuite/docs/guide-search.js'),
...
module.exports = {inserts, rootTokens, declarations, tokenCategory, colourName,
...
if (process.argv.includes('--check')) {
  if (!fs.existsSync(output) || fs.readFileSync(output, 'utf8') !== html) {
    console.error('Usage-Guide.html is stale. Run node tools/build-theme-usage.cjs.'); process.exitCode = 1;
...
require('./build-theme-config.cjs').build(module.exports, process.argv.includes('--check'));
listTemplates.build(module.exports, process.argv.includes('--check'));
actionBuilder.build(process.argv.includes('--check'));
require('./unified-action-example.cjs').build({nativePreviewCss,theme,themeJs,branding:clientRoots},process.argv.includes('--check'));
require('./account-menu-example.cjs').build(process.argv.includes('--check'));
require('./object-browser-example.cjs').build(process.argv.includes('--check'));
require('../.preview/build-bulletin-study.cjs')(process.argv.includes('--check'));
}
